...
public class NaverSearchUtills {
	...
	public static List<NewsItem> searchJson(String query) {
		...
		try {
			...
			String str_url=String.format("https://openapi.naver.com/v1/search/news.json?query=",
																							  query);
...
//			System.out.println(sb.toString());
			...
			for(int i=0;i<localArray.length();i++) {
				...
				JSONObject news = localArray.getJSONObject(i);
